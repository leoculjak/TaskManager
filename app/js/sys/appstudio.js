        ...
        fetch('_appstudio')
            ...
            .then(page => {
                if (page.match(/var __settings=\{/))
                    ...
                    // TODO: Add the parsed contents of the page to the log.
                    appIsNotOperational();
                }
        ...
        if (method) {
            ...
            switch (method) {
                ...
                case 'log':
                    ...
                    shield.addClass('studio-log').removeData('exception').empty();
                    _touch.notify(false);
                    break;
                case ':log':
                    return shield.is('.studio-log') && !shield.data('exception');
                case ':active':
