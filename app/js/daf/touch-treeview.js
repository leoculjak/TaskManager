...
(function () {
    ...
    function createNode(parent, nodes, nodeData) {
        for (var nodeName in nodes) {
            ...
            if (nodeTemplate.iterate && nodeData == null) {
                ...
                if (nodeTemplate.nodes) {
                    ...
                    createNode($ul().appendTo(li), nodeTemplate.nodes);
                }
            }
        }
    }
        ...
        fetchNodeRequest
            .then(list => {
                ...
                list.forEach(nodeData => {
                    createNode(parent, nodeInstance, nodeData);
                });
