...
namespace MyCompany.Models
{
    ...
    public partial class Schedules : SchedulesModel
    {
        ...
        public static MyCompany.Models.Schedules SelectSingle(int? iD)
        {
            return new SchedulesFactory().SelectSingle(iD);
        }
    ...
    public partial class SchedulesFactory
    {
        ...
        public MyCompany.Models.Schedules SelectSingle(int? iD)
        {
        ...
        protected virtual FieldValue[] CreateFieldValues(MyCompany.Models.Schedules theSchedules, MyCompany.Models.Schedules original_Schedules)
        {
            ...
            values.Add(new FieldValue("ID", original_Schedules.ID, theSchedules.ID, true));
        ...
        {
            return Update(theSchedules, SelectSingle(theSchedules.ID));
        }
