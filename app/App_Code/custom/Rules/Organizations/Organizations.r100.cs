...
namespace MyCompany.Rules
{
    public partial class OrganizationsBusinessRules : MyCompany.Rules.SharedBusinessRules
    {
        ...
        public void r100Implementation(OrganizationsModel instance)
        {
            ...
            {
                PreventDefault();
                Result.ShowAlert("Password and confirmation password doesn't match.");
            }
            else
            {
                ApplicationMembershipProvider.ValidateUserPassword(instance.OwnerEmail, instance.OwnerEmail);
            }
        }
    }
}
